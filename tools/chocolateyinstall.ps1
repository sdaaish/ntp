...
# https://www.meinbergglobal.com/english/sw/readme-ntpinstaller.htm#unattended

$packageName= $env:ChocolateyPackageName
$toolsDir   = "$(Split-Path -parent $MyInvocation.MyCommand.Definition)"
$url        = 'https://www.meinbergglobal.com/download/ntp/windows/ntp-4.2.8p10-win32-setup.exe' # download url, HTTPS preferred
$url64      = 'https://www.meinbergglobal.com/download/ntp/windows/ntp-4.2.8p10-win32-setup.exe' # 64bit URL here (HTTPS preferred) or remove - if installer contains both (very rare), use $url
$fileLocation = Join-Path $toolsDir 'install.ini'
...
$packageArgs = @{
  ...
  softwareName  = 'Meinberg-NTP' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique

  # Checksums are now required as of 0.10.0.
  # To determine checksums, you can get that from the original site if provided. 
  # You can also use checksum.exe (choco install checksum) and use it 
  # e.g. checksum -t sha256 -f path\to\file
  checksum      = 'AE081D5CFC6A8229ED161A6695E15AA5A0053743C62CE148F55D415634F3E067'
  checksumType  = 'sha256' #default is md5, can also be sha1, sha256 or sha512
  checksum64    = 'AE081D5CFC6A8229ED161A6695E15AA5A0053743C62CE148F55D415634F3E067'
  ...
  validExitCodes= @(0, 2) #please insert other valid exit codes here
}
